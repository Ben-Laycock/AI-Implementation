...
public class TestBoid : MonoBehaviour
{
    ...
    [Space]
    private TestBoidManager mManager = null;
    ...
    public void UpdateBoid(List<TestBoid> argNeighbours)
    {
    ...
    Vector3 ObstacleAvoidanceDirection()
    {
        ...
        int numberOfPaths = TestBoidManager.mCollisionTestDirections.Length;
        for (int i = 0; i < numberOfPaths; i++)
        {
            // Get test direction and convert it to world space relative to the boid
            Vector3 path = transform.TransformDirection(TestBoidManager.mCollisionTestDirections[i]);
    ...
    void Separate(List<TestBoid> argNeighbours)
    {
        ...
        foreach (TestBoid other in argNeighbours)
        {
    ...
    void Alignment(List<TestBoid> argNeighbours)
    {
    ...
    void Cohesion(List<TestBoid> argNeighbours)
    {
    ...
    public TestBoidManager GetManager()
    {
        return mManager;
    }

    public void SetManager(TestBoidManager argManager)
    {
        mManager = argManager;
    }
